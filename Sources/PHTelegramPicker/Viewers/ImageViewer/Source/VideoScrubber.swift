...
open class VideoScrubber: UIControl {
    ...
    func setup() {
      ...
      timeLabel.attributedText = NSAttributedString(string: "--:--", attributes: [NSAttributedString.Key.foregroundColor : self.tintColor ?? UIColor.red, NSAttributedString.Key.font : UIFont.systemFont(ofSize: 12)])
    ...
    @objc func updateCurrentTime() {
        ...
        if let duration = self.duration , self.duration != nil {
          ...
          timeLabel.attributedText = NSAttributedString(string: timeString, attributes: [NSAttributedString.Key.foregroundColor : self.tintColor ?? UIColor.red, NSAttributedString.Key.font : UIFont.systemFont(ofSize: 12)])
        }
        else {
          timeLabel.attributedText = NSAttributedString(string: "--:--", attributes: [NSAttributedString.Key.foregroundColor : self.tintColor ?? UIColor.red, NSAttributedString.Key.font : UIFont.systemFont(ofSize: 12)])
        }
