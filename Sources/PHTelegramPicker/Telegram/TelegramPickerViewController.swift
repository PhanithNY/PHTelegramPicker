...
final public class TelegramPickerViewController: UIViewController {
  ...
  public var locationTapHandler: (() -> Swift.Void)?
  
  public var useDefaultMap: Bool = true
   ...
   */
  public var disabledButtonTypes: [ButtonType] = [.contact, .documentAsFile, .file, .photoAsFile]
